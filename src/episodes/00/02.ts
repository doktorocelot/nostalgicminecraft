...
export const EPISODE_DEFINITION_02: EpisodeDefinition = {
    ...
    dl4k: '/torrents/00/Nostalgic_Minecraft.s01e02.4k.mkv.torrent',
    dl1080: '/torrents/00/Nostalgic_Minecraft.s01e02.1080p.mkv.torrent',
    bg: thumb,
    ...
    subsList: [
        {
            dl: '/subs/00/Nostalgic_Minecraft.s01e02.en.ass',
            lang: 'en',
            author: 'Dr Ocelot',
        }
    ],
